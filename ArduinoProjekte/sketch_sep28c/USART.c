...
@b History:
- 1.3 LiTec/ZUKW fixed compiler-warnings for AVRs with only one USART
...
void USARTInit (uint8_t uart, uint32_t baud,
  ...
  (void) uart;  // this microcontroller only has one uart, avoid compiler-warnings
